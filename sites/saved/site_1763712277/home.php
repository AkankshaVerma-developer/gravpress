...
<body>
 <header class="gp-header">
  ...
  <section class="hero">
    <div class="hero-box">
      <div class="hero-left">
        <h2 style="font-size: 44px; color: #be0909;">Style meets Comfort</h2>
        <p>Explore our latest collection design for vibrant lifestyles fashion that defines you</p>
  ...
  <section class="shop">
    <div class="shop-box">
      <h2 style="font-size: 44px; color: #be0909;">New Arrivals</h2>
      <div class="grid">
        <div class="card">
  ...
  <section class="touch">
    <div class="touch-box">
      <div class="touch-left">
        <h2 style="font-size: 44px; color: #be0909;">Get in Touch</h2>
